...
public class MyRedisCache2<K,V> implements org.apache.shiro.cache.Cache<K, V>{
    private static final Logger log = LoggerFactory.getLogger(MyRedisCache2.class);
    private CacheManager cacheManager;
    private Cache cache;
    //    private RedisCache cache2;
    public MyRedisCache2(String name, CacheManager cacheManager) {
