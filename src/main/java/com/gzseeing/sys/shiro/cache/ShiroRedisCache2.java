...
/**
 * <p>
 * shiro他自己的缓存 将数据存入到redis中,目前realm有用到
 * </p>
 * 
 * @author xxx
 * @date 2018年2月1日
...
public class ShiroRedisCache2<K, V> implements org.apache.shiro.cache.Cache<K, V> {
    private static final Logger log = LoggerFactory.getLogger(ShiroRedisCache2.class);
    private CacheManager cacheManager;
    private Cache cache;

    // private RedisCache cache2;
    public ShiroRedisCache2(String name, CacheManager cacheManager) {
