...
import com.gzseeing.sys.springmvc.resolver.AppDataAnnotationMethodArgResolver;
import com.gzseeing.sys.springmvc.resolver.AppDataMethodArgResolver;

public abstract class AbstractAnnotationInterceptorMvcConfigurerAdapter extends WebMvcConfigurerAdapter {
    @Autowired
